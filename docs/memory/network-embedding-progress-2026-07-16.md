...
## Phase 4 performance-gate evidence (exclusive-GPU window, 2026-07-17, 2x RTX A6000, merged tree c479203)
...
- Both Phase 4 performance gates are now backed by reproducible artifacts on the merged tree `c479203` (see "Phase 4
