...
The 2026-07-16 repository state contains 135 guards:

- 114 capability guards tracked by the non-increasing test budget;
...
The 2026-07-16 network-embedding reconciliation is detailed in the
...
capability gaps and raise `CAPABILITY_GUARD_BUDGET` from 108 to 114; the seventh
