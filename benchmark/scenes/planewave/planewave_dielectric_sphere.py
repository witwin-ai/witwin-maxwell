...
def build_scene() -> mw.Scene:
    scene = (
        base_scene()
        .add_structure(mw.Structure(geometry=mw.Sphere(position=(0.0, 0.0, 0.0), radius=0.12), material=mw.Material(eps_r=4.0), name="dielectric_sphere"))
        .add_source(
            mw.PlaneWave(
...
SCENARIO = ScenarioDefinition(
    name="planewave_dielectric_sphere",
    description="Plane wave scattering from a dielectric sphere.",
    builder=build_scene,
