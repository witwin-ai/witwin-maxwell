...
- Tidy3D export rejects anisotropy, magnetic dispersion, and Kerr media explicitly in v1. The FDTD adjoint bridge supports diagonal (`DiagonalTensor3`) epsilon anisotropy but still rejects full off-diagonal (`Tensor3x3`) permittivity, `mu_tensor` anisotropy, magnetic dispersion, and Kerr media explicitly
